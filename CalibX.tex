...
\pagestyle{fancy}
\fancyhf{}  
\fancyhead[C]{\zihao{5}  \kaishu 高精度传感器标定}
...
%	\include{body/chapter7_linjx}
%	\include{body/zhiming}
%	\include{body/zengjie}
%	\include{body/xiaomeng}
%	\include{body/hongfei}
%	\include{body/lingbing}
	%============= 参考文献 =====================
