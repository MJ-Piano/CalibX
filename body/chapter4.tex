...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{figure/cp4/gs_imu_cam_timeshift}
	\caption{全局曝光相机timeshift}
	\label{fig:gs-timeshift}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{figure/cp4/rs_imu_cam_timeshift}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{figure/cp4/correlation}
	\caption{相机标定流程图}
